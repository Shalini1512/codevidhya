<template>
  <div id="cQuizPage" class="h-100 w-100" style="position:fixed;">
    ...
    <div class="row h-100 p-0" id="main">
      <div class="col-xl-3 col-md-3" id="quiz-editor-sidebar">
        <div
          class="mb-3"
      ...
      <div class="col-xl-9 col-md-9" id="quiz-editor-mainbar">
        <div>
...
export default {
  ...
  //props: ["quizID","quiz_slug","SubjectName","QuizName","subID","quizPrice"],
  data() {
    return {
  ...
  methods: {
    ...
    updt_price: function() {
      ...
      if (ans == "Edit") {
        ...
        axios("/api/user/UpdateQuizPrice", {
    ...
    get_subject: function() {
      axios.post("/api/user/get_subject").then(function(res) {
