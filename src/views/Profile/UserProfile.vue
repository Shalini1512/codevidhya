        ...
        <div class="wideget-user">
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <button class="btn btn-primary" @click="backPreviousPart($event)">
                Back
              </button>
              <div class="wideget-user-desc text-center">
                ...
                <!--<div class="profile-pic-img" >
                              <img
                                class="brround"
                                :src="
                                  userProfile.length?userProfile[0].profile_pic ?
                                     '/static/profiles/' +
                                      userProfile[0].profile_pic
                                    : '/assets/images/users/user.svg'
                                    :'/assets/images/users/user.svg'
                  ...
                  <span
                    ...
                    v-if="
                      userProfile.length
                        ...
                        : false
                    "
                    >Grade: {{ userProfile[0].grade }}</span
                  >
                </div>
              </div>
            </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <span
            ...
            ></span>
            <span v-else class="flex-grow-1">{{
              userProfile.length ? userProfile[0].grade : ""
            }}</span></span
          >
        </div>
        <div class="row my-2">
            ...
            <span v-if="account_setting" class="">
              <span class="input-group m-0 p-0 flex-grow-1">
                <input
                  ...
                  class="account_input"
                  style="color: #2e384d;opacity:1;"
                  :value="userProfile.length ? userProfile[0].password : ''"
