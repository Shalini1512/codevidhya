            ...
            <div class="card-body">
             <!-- <table
                    ...
                    <tr :key="index">
                      ...
                      <td>
                        <button
                          ...
                          :disabled="assessment.sch_id == 0 ? true : false"
                          @click="
              ...
              <div
                ...
                v-if="assessment.sch_id == sch_id"
              >
                --Table row to add new class--
                <a
                  href="#"
                  onclick="showModal('assignSchedule-modal')"
                  class="link-a p-2"
                  ><p>Click here to assign and schedule this assessment</p></a
                >
              </div>-->
              <div v-if="assessment.sch_id == sch_id">
                <div class="panel-group1 mt-4" id="accordion2">
                  <div
                  ...
                  >
                    <div class="panel-heading1">
                      ...
                      >
                        <div class="col-sm-10 d-flex align-items-center">
                          <h3 style="color: #000000;">Assessment questions</h3>
                        </div>
                    ...
                    >
                      <div class="panel-body p-0 ">
                        <table
                          class="m-0 table card-table text-wrap table-bordered border-top mb-0"
                        >
                          <thead class="bg-secondary text-white">
                            <tr>
...
export default {
  components: { NewQuestion, Header, Footer },
  data() {
    return {
      ...
      this.$http
        ...
        .then(function(res) {
          if (res.body.status == "403") {
            ...
            //this.assessments = res.body._assessments;
