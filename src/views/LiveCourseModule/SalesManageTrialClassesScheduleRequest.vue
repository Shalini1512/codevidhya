        ...
        <div class="header-text mb-0">
          <div class="container">
            <div class="text-center text-white">
              <h1 class>Demo Session Sales Management</h1>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <table class="table card-table table-vcenter text-nowrap" style="overflow:auto">
                    <thead class="bg-secondary text-white">
                      <tr>
                        ...
                        <th class="text-white">Feedback Status</th>
                      ...
                      >
                        ...
                        <template v-for="(feedback,key) in feedbacks">
                          <option
                            ...
                            :selected="feedback.feedback_status ==data.feedback_status?true:false"
...
export default {
  ...
  methods: {
    feedbackMethod(key) {
      //let option =$("#user-feedback"+(key+1)).val();

      /*if(option!="0")
       {
          let option_val =$("#user-feedback"+(key+1)+" option:selected").text();
          $('#feedback-status'+(key+1)).val(option_val)
