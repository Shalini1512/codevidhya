  ...
  <div>
    ...
    <div class="container-fluid" style="margin-top: 58px; background: #008dd2;">
      ...
      <div class="row m-0 mt-3 justify-content-center">
              ...
              >
                <span class="mr-2">
                  ...
                  <span class="ml-1" style="color: ;">
                    {{courseDetails.length? courseDetails[0].grade.split(",")[0]: ""}}+
                  </span>
                </span>
                <span class="mx-2">
                  Age:
            ...
            <div class="mt-2 ml-2">
              ...
              <ul class="list-group" style="margin-bottom: 10px;">
                <li
                  ...
                  style=" border: none;font: normal 1rem 'Poppins'; background: #008dd2;"
        ...
        <div class="col-xl-3">
          <div
            class="card overflow-hidden m-0 p-2"
    ...
    <div class="container-fluid" style="background: #fff !important;">
      <div class="row m-0 mt-3 justify-content-center" style="padding-right: 10px;">
        <div class="col-lg-7 text-right">
          <span class="text-dark font-weight-semibold h1" style="color: #04b00f !important;">
            {{
          ...
          <span>
          <span v-if="courseDetails && courseDetails.length ? courseDetails[0].purchases_status || trainer ? true : false : false">
            <button class="btn btn-pill btn-primary align-top">
              Purchased
            </button>
          </span>
            ...
            <button
              v-if="
                courseDetails && courseDetails.length
                  ...
                  : false
              "
              class="btn btn-pill btn-primary align-top"
              @click.prevent="
                directPaymentModule(
                  courseDetails.length
          ...
          <!-- <a href="#" class="btn btn-pill btn-primary align-top">Buy Now</a> -->
        </div>
      </div>
    </div>
    <!--courses-->
    <section class="sptb ml-2 p-0" style="background: #fff !important;">
      <div class="row m-0 p-0 mt-2">
        <div class="row d-flex w-100 border-bottom justify-content-center">
          <div class="col-xl-7 col-lg-7 border-right col-md-12 flex-grow-1 bg-white mb-10" style="margin-bottom: 20px;">
            <div
            ...
            <!--courses details-->
            <div class="tab-content border-left p-5 bg-white details-tab-content" style="border: none;">
          ...
          <!-- <div class="col-xl-4 col-lg-4 border-left col-md-12 flex-grow-1 bg-white">
            <div
              :class="
              ...
              >
                <div class="mb-2" style="font: 'Poppins';">
                  <div>
                    ...
                    <div v-if="courseDetails && courseDetails.length ? courseDetails[0].purchases_status || trainer ? true : false : false">
      ...
      <div class="m-0">
        <div class="card p-0 m-0">
          ...
          <!-- other courses-->
          <otherCourses :liveCourseName="liveCourseName" />
          <!--end other courses-->
        </div>
      </div>
    </section>
