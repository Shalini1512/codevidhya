<template>
  ...
  >
    ...
    <div class="header-main">
      <header class="header-search header-logosec py-4">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-12 text-right">
              <div class="row justify-content-end py-0" v-if="user_id != 0">
                <button class="full-user-name bell-icon mr-1">
                  {{ name }}
                </button>
                <span>
                  <button
                    class="a-bell-icon bell-icon"
              ...
              <div v-else class="header-icons float-right">
                <div class="top-bar-right">
                  <ul class="custom">
                    <template v-if="shouldShowLoggedInState()">
                      <li>
                        <a href="#" class="text-dark" @click="doLogout()">
                          <i class="fas fa-user mr-1"></i>
                          <span>Logout</span>
                        </a>
                      </li>
                    </template>
                    <template v-else-if="!onLoginPage()">
                      <li>
        ...
        <div class="horizontal-mainwrapper container clearfix">
          <nav class="horizontalMenu clearfix d-md-flex">
            <ul class="horizontalMenu-list">
              ...
              >
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li>
                    ...
                    <router-link to="/resource/assessments">
                      Assessments
                    </router-link>
                  ...
                  >
                    ...
                    <li class="dropdown-header">
                      {{ $store.getters.getAuthData.programs.sch_name }}
                    </li>
                    <li>
                      <a
              ...
              <li
                aria-haspopup="true"
                v-if="auth_role_id == 3 && programs.assessment == 1"
              >
                <router-link to="/assessments">Assessments</router-link>
              </li>
              <li aria-haspopup="true" v-if="auth_role_id == 3">
                <router-link to="/live-class/certificate">
                  My Certificate
                </router-link>
              </li>
              <!--<li aria-haspopup="true" v-if="!user_id">
                <router-link to="/individual/assessment"
              ...
              <li
                ...
                aria-haspopup="true"
                class="d-lg-none mt-5 pb-5 mt-lg-0"
              >
                <span>
  ...
  methods: {
    ...
    down_bridge: function () {
      ...
      if (grade != 0) {
        ...
        link.href = '/dynamic/cv_resources/bridgeCourse/grade_' + grade + '.pdf'
    ...
    down_lesson_plan: function () {
      var grade = document.getElementById('grade-select_lessonplan_grade').value
